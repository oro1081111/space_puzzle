...
最新研究試作：[PV2 Policy/Value 兩階段評估](PV2_PILOT.md)。15／30 三人新流程已執行，但強度未通過發布門檻，**未取代線上模型**。

最新三人決策修正：[ATLAS-R Trio v1.1](ATLAS_TRIO_v1.1.md)。保持模型權重不變，以正常開局驗證完整聯合動作搜尋與多步圈地規劃；內含未改善的局面與重現指令。
